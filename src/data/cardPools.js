...
export const cardPools = {
  ...
  UR03: {
    ...
    cardIds: {
      [RARITY.UR]: [1906, 1211],
      [RARITY.SSR]: [1201, 1203, 1210, 1206, 1209],
      [RARITY.SR]: [1103, 1104, 1207, 1303, 1405, 1604, 1606, 1702, 1205, 1304, 1805, 1202, 1404],
  ...
  Normal01: {
    ...
    cardIds: {
      [RARITY.SSR]: [
        1102, 1106, 1108, 1109, 1201, 1209, 1203, 1210, 1301, 1302, 1305, 1310, 1401, 1402, 1403,
