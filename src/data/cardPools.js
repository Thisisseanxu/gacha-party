  ...
  [
    '137',
    {
      ...
      rules: {
        ...
        [SSR]: {
          doubleRateCards: ['冰匙娃娃'],
        },
      },
      cardNames: {
        [SP]: ['波子汽水', '清凉冰箱贴'],
        [SSR]: ['冰匙娃娃', '制冰机', '寒冰战士', '织夜', '球球射手'],
        [SR]: [
          '珍珠射手',
          '饼干骑士',
          '劈咔灯泡',
        ...
        [R]: ['铁头娃娃', '纸杯千竹', '转转咖啡杯', '迷你风扇', '闪耀灯球', '火柴女孩'],
      },
    },
  ],
